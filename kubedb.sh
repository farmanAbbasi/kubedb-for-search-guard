...
export KUBEDB_NAMESPACE=kube-logging
...
show_help() {
  ...
  echo "-n, --namespace=NAMESPACE              specify namespace (default: kube-logging)"
...
$ONESSL has-keys configmap --namespace=kube-logging --keys=requestheader-client-ca-file extension-apiserver-authentication || {
